...
public class AudienceManager1 : MonoBehaviour
{
    ...
    */
    ...
    void ScoreChange() {
        audienceGraph.GetComponent<AudienceGraph1>().ScoreChange(score);
        audience.GetComponent<Audience1>().ScoreChange(score / 100);
    }
