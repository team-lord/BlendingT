...
public class BeeB : MonoBehaviour {
    ...
    private bool canFire3; // bulletHoneyExplosiveQ;
    public float fire3DelayQ;

    public GameObject bulletQ;
    public GameObject bulletHoneyExplosiveQ;
    ...
    void Update() {
        if (!isLethal) {
            ...
            switch (phase) {
                case 3:
                    if (canFire3) {
                        StartCoroutine(Fire3(fire3DelayQ));
                    }
                    break;
                case 2:
                case 1:
    ...
    void Fire3Bullet() {
        ...
        Instantiate(bulletHoneyExplosiveQ, transform.position, Quaternion.LookRotation(Vector3.up, _direction));
    }
